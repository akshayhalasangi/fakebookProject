Profile = React.createClass({
  ...
  getInitialState(){
    return{
      klass:'img-circle img-resposive custom-input-file',
      editmode:false,
      email:this.data && this.data.currentUser && this.data.currentUser.emails ? this.data.emails[0].address:'you@yourdomain.com'
    }
  },
  toggleEdit(){
  ...
  uploadFile(e){
    ...
    FS.Utility.eachFile(e,function(file){
      Images.insert(file,function(err,fileObj){
        ...
        setTimeout(function(){
          that.setState({klass:'img-circle img-resposive custom-input-file updated'});
        },100)
      });
    })
  },
  render(){
    ...
    return(
        <div className="row">
          <div className="center" className="col-md-2 hidden-xs">
