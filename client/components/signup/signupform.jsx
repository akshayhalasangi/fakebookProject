        ...
        <form onSubmit={this.handleSubmit}>
          <div className="col-sm-9">
            ...
            <div className="form-group">
              <input type="text" ref="email" placeholder="Email or Mobile number" className="form-control"/>
            </div>
            <div className="form-group">
              <input type="password" ref="password" placeholder="Password" className="form-control"/>
            </div>
            <button type="submit" id="btn" className="btn btn-md btn-success">Sign Up</button>
